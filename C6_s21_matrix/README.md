...
4. [Операции над матрицами](#операции-над-матрицами)
   

## Введение

Проект реализован по учебной программе [Школы 21](https://21-school.ru).   
![matrix](src/images/matrix.png)

В данном проекте реализована своя библиотека для обработки числовых матриц на языке программирования Си. Матрицы являются одной из базовых структур данных в программировании.
Все функции покрыты юнит тестами
